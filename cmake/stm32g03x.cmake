...
##
##
## STM32G03x target specific CMake file
##
...
# -mcpu=cortex-m0plus  Specifies target ARM processor.
# -mthumb              Specifies Thumb command set.
...
# Linker flags
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${OBJECT_GEN_FLAGS} -T${LINKER_SCRIPT}" CACHE INTERNAL "Linker options")